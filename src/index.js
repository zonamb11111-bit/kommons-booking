...
const CSP_DIRECTIVES = [
  ...
  "script-src 'self' 'unsafe-inline' https://*.googletagmanager.com https://*.googleadservices.com https://googleads.g.doubleclick.net https://static.line-scdn.net https://*.line.me https://*.squarecdn.com https://js.squareup.com https://js.squareupsandbox.com https://pay.google.com https://*.gstatic.com",
  "script-src-elem 'self' 'unsafe-inline' https://*.googletagmanager.com https://*.googleadservices.com https://googleads.g.doubleclick.net https://static.line-scdn.net https://*.line.me https://*.squarecdn.com https://js.squareup.com https://js.squareupsandbox.com https://pay.google.com https://*.gstatic.com",
  ...
  "img-src 'self' data: https://*.googletagmanager.com https://*.google-analytics.com https://*.g.doubleclick.net https://*.google.com https://*.google.co.jp https://*.line-scdn.net https://*.squarecdn.com https://*.gstatic.com",
  ...
  // GTM noscript用iframe・Google Ads iframe・LINE LIFF認証画面・Square カード入力iframe・Google Pay
  "frame-src https://*.googletagmanager.com https://*.doubleclick.net https://*.line.me https://*.squarecdn.com https://pay.google.com",
  "object-src 'none'",
  "base-uri 'self'",
...
const SECURITY_HEADERS = {
  ...
  // payment=：Apple Pay / Google Pay の決済APIを self ＋ Square/GooglePay の iframe に許可（デポジット用）
  'Permissions-Policy': 'camera=(), microphone=(), geolocation=(), interest-cohort=(), payment=(self "https://web.squarecdn.com" "https://sandbox.web.squarecdn.com" "https://pay.google.com")',
  'X-Frame-Options': 'SAMEORIGIN',
  // Google Pay はポップアップを開くため same-origin-allow-popups（Square 推奨。same-origin だと iOS で 400 になる）
